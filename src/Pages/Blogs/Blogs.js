...
const Blogs = () => {
  return (
    <div className="grid grid-cols-1 gap-5 mx-3 my-7 max-w-7xl xl:mx-auto">
      <div className="text-left border-2 rounded-xl px-4 py-3">
        <p className="font-semibold text-xl">
          <span>1.</span> How to improve the performance of a React application?
        </p>
        <p className="text-lg">
          ...
          <ul className="list-disc mx-5">
            <li>
              Use React.Fragment or, '<></>' to avoid adding extra nodes to the
              DOM.
            </li>
            <li>
      ...
      <div className="text-left border-2 rounded-xl px-4 py-3">
        ...
        <p className="text-lg">
          <span className="font-semibold">Ans.</span> There are four main types
          of state you need to manage state in your React apps:
          <ul className="list-disc mx-5">
            <li>
            ...
            <li>
              Global state: To manage global state, you can use tried and tested
              third-party libraries like 'Zustand', 'Jotai', and 'Recoil'. Or,
              you can prefer Redux toolkit.
            </li>
            <li>
            ...
            <li>
              URL state: To manage URL state, React Router is the best option to
              manage.
            </li>
          </ul>
        </p>
      ...
      <div className="text-left border-2 rounded-xl px-4 py-3">
        ...
        <p className="text-lg">
          <span className="font-semibold">Ans.</span> The Prototypal Inheritance
      ...
      <div className="text-left border-2 rounded-xl px-4 py-3">
        ...
        <p className="text-lg">
          <span className="font-semibold">Ans.</span> Unit testing is a software
          development process in which the smallest testable parts of an
          application, called units, are individually and independently
