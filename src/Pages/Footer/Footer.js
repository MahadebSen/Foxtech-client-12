...
const Footer = () => {
  return (
    <footer className="bg-black">
      <div className="max-w-7xl mx-auto mt-20 px-12 py-10 text-center md:text-left md:flex justify-between">
        <div>
          <img
          ...
          <p className="text-white">&#169; 2008-2023 FOXTECH</p>
        </div>
